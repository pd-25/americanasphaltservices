                    ...
                    <div class="col-lg-6">
                        <div class="th-left">
                            <a href=""><i class="fa fa-envelope" aria-hidden="true"></i>
                                info@americanasphaltservices.com</a>
                        </div>
                    </div>

                    <div class="col-lg-6">
                        <div class="th-right">
                            <a href=""><i class="fa fa-map-marker" aria-hidden="true"></i> 10467 Hoke Run Drive
                                Colorado Springs, CO 80925</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <nav class="menu">
                            ...
                            <ul class="menu-section">
                                ...
                                <li class="menu-item-has-children">
                                    ...
                                    <div class="menu-subs menu-column-1">
                                        <ul>
                                            ...
                                            <li><a href="{{ route('patching_and_crack_filling') }}">Patching and Crack
                                                    Filling</a></li>
                                        </ul>
                                    </div>
                                </li>
                                ...
                                <li><a href="" class="menu-btn" data-toggle="modal"
                                        data-target="#exampleModal">Raise A Query </a></li>
                            </ul>
                        </nav>
                    </div>
                    ...
                    <form role="form" action="{{ route('contact_usPost') }}" method="post" id="contact-form">
                        ...
                        <div class="controls">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input type="text" required="required" placeholder="Full name"
                                            class="form-control text-left" name="form_name" id="form_name">
                                            @error('form_name')
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input type="text" required="required" placeholder="Address"
                                            class="form-control text-left" name="form_address" id="form_address">
                                            @error('form_address')
                                            <span class="text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input type="email" required="required" placeholder="Email"
                                            class="form-control text-left" name="form_email" id="form_email">
                                            @error('form_email')
                                            <span class="text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input type="tel" required="required" placeholder="Phone no"
                                            class="form-control text-left" name="form_phone" id="form_phone">
                                            @error('form_phone')
                                            <span class="text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <textarea data-error="Please,leave us a message." required="required" rows="3"
                                            placeholder="Description of Project:" class="form-control text-left" name="form_message" id="form_message"></textarea>
                                            @error('form_message')
                                            <span class="text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 fst-footer">
                        ...
                        <p class="mb-3">American Asphalt Services, based in Colorado Springs, boasts over 30 years of
                            expertise in the asphalt industry. </p>
                    </div>
                    ...
                    <div class="col-lg-2 snd-footer">
                        ...
                        <ul class="footer-menu">
                            ...
                            <li><a href="{{ route('snow_removal') }}">Snow Removal</a></li>
                            <li><a href="{{ route('asphalt_paving') }}">Asphalt Paving</a></li>
                            <li><a href="{{ route('patching_and_crack_filling') }}">Patching and Crack Filling</a>
                            </li>
                        </ul>
                    </div>
...
<p class="footer-contact mb-0"><i class="fa fa-phone" aria-hidden="true"></i><a style="color: white" href="tel:{{ $originalNumber }}">{{ $formattedNumber }}</a>
        ...
        <div id="footer-copyright">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <p class="footer-copyright">Copyright © 2024, American Asphalt Services. All Rights Reserved.
                        </p>
                    </div>
                </div>
            </div>
